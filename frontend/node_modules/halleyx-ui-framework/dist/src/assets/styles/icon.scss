@font-face {
    ...
    src:  url('./assets/fonts/halley-icons-v6.eot?pk23ai#iefix') format('embedded-opentype'),
      url('./assets/fonts/halley-icons-v6.ttf?pk23ai') format('truetype'),
      url('./assets/fonts/halley-icons-v6.woff?pk23ai') format('woff'),
      url('./assets/fonts/halley-icons-v6.svg?pk23ai#halley-icons-v6') format('svg');
    font-weight: normal;
    font-style: normal;
    font-display: block;
  }
